    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 图书·添加</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> 图书基本信息</h4>
                        <form class="form-horizontal style-form" method="post" action="/admin_book_add">
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·书名</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="bookName">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·图书编号：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="bookId">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·作者：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="author">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·出版社：</label>
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="publishHouse">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label" >·出版日期：</label>
                                <div class="col-sm-11">
                                    <input type="date" class="form-control" name="publishTime">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-1 col-sm-1 control-label">·现有量:</label>
                                <div class="col-sm-11">
