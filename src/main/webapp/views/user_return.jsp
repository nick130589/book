            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        ...
                        <li class="active"><a  href="/user_return">归还·登记</a></li>
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 归还·登记</h3>
            ...
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        ...
                        <form class="form-horizontal style-form" method="post" action="/user_return">
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label">归还时间</label>
                                <div class="col-sm-11">
                                    <input type="date" class="form-control" placeholder="2017-12-11" name="returnTime">
                                </div>
                            </div>

                            <input type="submit" value="确认归还" class="btn btn-theme">
                        </form>
                        <br>
                        <div>${error}</div>
                    </div>
