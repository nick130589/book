    ...
    *********************************************************************************************************************************************************** -->
    ...
    <section id="main-content">
        <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> 学生·修改</h3>

            <!-- BASIC FORM ELELEMNTS -->
            <div class="row mt">
                <div class="col-lg-12">
                    <div class="form-panel">
                        <h4 class="mb"><i class="fa fa-angle-right"></i> 修改学生基本信息</h4>
                        <form class="form-horizontal style-form" method="post" action="/admin_student_revise?studentID=${studentID}&realname=${realname}">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-11">
                                    <input type="text" class="form-control" name="studentID" value="${studentID}" placeholder="${studentID}" disabled="disabled">
                                </div>
                            </div>
                            <div class="form-group">
